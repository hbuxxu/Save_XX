...
typedef union 
{
	struct
	{
		...
		u8 Flag_TestC        							:1;      //上位机测试曲线数据标志
		u8 Flag_TestC1        						:1;      //上位机测试曲线数据标志1
...
{				
		...
		uint8_t Par7_LeftAverZero;      //左动态平均零值 daN
		uint8_t Par8_RightAverZero;    //右动态平均零值 daN
...
extern uint8_t u8Tran_CurrentZ[2010],				//阻滞上传数据
