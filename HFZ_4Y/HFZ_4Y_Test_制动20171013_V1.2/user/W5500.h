...
#define S_TX_SIZE	4096  	/*定义Socket发送缓冲区的大小，可以根据W5500_TMSR的设置修改 */

/***************----- W5500 GPIO定义 -----***************/
#define W5500_SCS		GPIO_Pin_4	//??W5500?CS??	 
#define W5500_SCS_PORT	GPIOA

#define W5500_RST		GPIO_Pin_4	//??W5500?RST??
#define W5500_RST_PORT	GPIOC

#define W5500_INT		GPIO_Pin_5	//??W5500?INT??
#define W5500_INT_PORT	GPIOC

/**********************复位引脚定义************************/
#define SYSTEM_REST		GPIO_Pin_0	//系统恢复出厂设置引脚
#define SYSTEM_REST_PORT	GPIOE
...
extern unsigned char S1_Port[2];   //接口1的本地端口号60000   UDP调试用
...
extern unsigned char S1_Mode;	//端口1的运行模式,0:TCP服务器模式,1:TCP客户端模式,2:UDP(广播)模式
/***************----- 端口的运行状态 -----***************/
extern unsigned char S1_State ;	//端口1状态记录,1:端口完成初始化,2端口完成连接(可以正常传输数据) 
/***************----- 端口收发数据的状态 -----***************/
extern unsigned char S1_Data;		//端口1接收和发送数据的状态,1:端口接收到数据,2:端口发送数据完成 

extern unsigned char S2_Mode;	//端口2的运行模式,0:TCP服务器模式,1:TCP客户端模式,2:UDP(广播)模式
/***************----- 端口的运行状态 -----***************/
extern unsigned char S2_State;	//端口2状态记录,1:端口完成初始化,2端口完成连接(可以正常传输数据) 
/***************----- 端口收发数据的状态 -----***************/
extern unsigned char S2_Data;		//端口2接收和发送数据的状态,1:端口接收到数据,2:端口发送数据完成 

//调试使用
extern unsigned char S3_Port[2];	//端口3的端口号(6666) 调试使用端口 
extern unsigned char S3_Mode;	//端口3的运行模式,0:TCP服务器模式,1:TCP客户端模式,2:UDP(广播)模式
/***************----- 端口的运行状态 -----***************/
extern unsigned char S3_State;	//端口3状态记录,1:端口完成初始化,2端口完成连接(可以正常传输数据) 
/***************----- 端口收发数据的状态 -----***************/
extern unsigned char S3_Data;		//端口3接收和发送数据的状态,1:端口接收到数据,2:端口发送数据完成 
...
extern void EXTI9_5_ISR(void);  //W5500网络接收完成中断

/**********需初始化函数*************/
extern void  W5500_SPI_Configuration(void);
