...
#define W5500_INT		GPIO_Pin_5	//定义W5500的INT引脚
...
extern unsigned char S0_Port[2];	//端口0的端口号(50000) 
extern unsigned char S0_DIP[4];		//端口0目的IP地址 
extern unsigned char S0_DPort[2];	//端口0目的端口号(60000) 
...
/***************----- 端口数据缓冲区 -----***************/
extern unsigned char W5500_Rx_Buffer[];	//端口接收数据缓冲区 
extern unsigned char W5500_Tx_Buffer[];	//端口发送数据缓冲区 

extern unsigned char W5500_Interrupt;	//W5500中断标志(0:无中断,1:有中断)
typedef unsigned char SOCKET;			//自定义端口号数据类型

extern unsigned char ucW5500_InitCTR;
